...
export default function Contact() {
  return (
    <div className="h-[50rem] px-4 w-full dark:bg-black bg-white  dark:bg-grid-white/[0.07] bg-grid-black/[0.07] relative flex flex-col items-center justify-center">
